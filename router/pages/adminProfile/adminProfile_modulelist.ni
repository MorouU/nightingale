...
<html lang="en">
  ...
  <body class="noteplus-layout  ">
                           ...
                           <div class="row justify-content-between">
                                 ...
                                 <div id="user_list_datatable_info" class="dataTables_filter">
                                    <form class="mr-3 position-relative">
                                       <div class="form-group mb-0">
                                          <input type="search" class="form-control" id="findInputSearch" placeholder="模块ID/模块名称" aria-controls="user-list-table">
                                       </div>
                                    </form>
                                 </div>
                              </div>
                              <div class="col-sm-6 col-md-6">
                                 <div class="user-list-files d-flex">
									<a class="bg-info" href="#" id="moduleBack">
                                       返回
                                    </a>
        ...
        <div class="modal-dialog modal-dialog-centered" style="width:1000px">
            <div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title" id="editModuleTitle">编辑模块</h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="card-body write-card pb-8">
                        <div class="row">
                            <div class="col-md-12">
									<input type="hidden" id="editModuleID" value="">
                                    <div class="form-group">
                                        <label class="label-control">模块名称</label>
                                        <input type="text" class="form-control" id="editModuleName" placeholder=" -- 请输入任务名称 -- " value="" data-change="input" >
                                    </div>
									<div class="form-group">
                                        <label class="label-control">模块描述</label>
                                        <textarea type="text" class="form-control" id="editModuleData" rows="3" data-change="input"  placeholder=" -- 请输入任务描述 -- "></textarea>
                                    </div>
									<div class="form-group">
                                        <label class="label-control">模块代码</label>
                                       <textarea type="text" class="form-control" id="editModuleCode" rows="3" data-change="input"  placeholder=" -- 请输入任务描述 -- "></textarea>
                                    </div>
                            </div>
                        </div>
                    </div>
			  ...
			  <div class="modal-footer">
				<div class="col-sm-12 text-right">
					...
					<button type="button" class="btn btn-outline-primary ml-1" id="editModuleSave" data-dismiss="modal">保存</button>
				</div>
			  </div>
            </div>
        </div>
	...
	<div class="modal fade" id="delete-module" tabindex="-1" role="dialog" aria-hidden="true">
	...
	<script src="/static/adminProfile/assets/js/modules.js"></script>
